...
async function loadCustomerData() {
  ...
  try {
    let response = await axios.get("http://localhost:8888/users/profile", {
    ...
    document.getElementById("desired_payrate").value =
      userProfile.join_date || "";
    document.getElementById("available_time_per_week").value =
      userProfilea.join_date || "";
  } catch (error) {
